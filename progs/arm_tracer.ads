...
package ARM_Tracer is

   type Tracer_Output_Type is new ARM_Output.Output_Type with private;
   ...
   procedure Close (Self : in out Tracer_Output_Type);
   ...
   procedure Section
     (Self : in out Tracer_Output_Type; Section_Title : in String;
   ...
   procedure End_Paragraph (Self : in out Tracer_Output_Type);
   -- End a paragraph.

   procedure Category_Header
     (Self : in out Tracer_Output_Type; Header_Text : String);
   ...
   procedure Clause_Header
     (Self : in out Tracer_Output_Type; Header_Text : in String;
   ...
   procedure TOC_Marker
     (Self : in out Tracer_Output_Type; For_Start : in Boolean);
   ...
   procedure New_Column (Self : in out Tracer_Output_Type);
   ...
   procedure Hard_Space (Self : in out Tracer_Output_Type);
   -- Output a hard space. No line break should happen at a hard space.

   procedure Line_Break (Self : in out Tracer_Output_Type);
   ...
   procedure Soft_Line_Break (Self : in out Tracer_Output_Type);
   ...
   procedure Soft_Hyphen_Break (Self : in out Tracer_Output_Type);
...
-- a hyphen will be added to the text.
   ...
   procedure Tab (Self : in out Tracer_Output_Type);
   ...
   procedure End_Hang_Item (Self : in out Tracer_Output_Type);
...
private
  ...
  type Tracer_Output_Type is new ARM_Output.Output_Type with record
